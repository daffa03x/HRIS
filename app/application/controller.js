...
module.exports = {
  index: async (req, res) => {
    try {
      ...
      const statuses = ["Hired", "Interview Scheduled", "Received", "Under Review", "Rejected"];
      const applications = await Application.findAll({
        include: [
          {
            model: Recruitment,
            attributes: ["job_title"], // Atribut yang ingin Anda ambil dari Recruitment
          },
        ],
      });
      res.render("application/index", { applications, statuses, alert });
    } catch (error) {
