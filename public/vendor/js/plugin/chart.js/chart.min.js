        ...
        function (t, e, i) {
          ...
          function u(t) {
            var e = t[0] / 255,
              ...
              n = t[2] / 255;
            return [
              100 * (0.4124 * (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) + 0.3576 * (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92) + 0.1805 * (n = n > 0.04045 ? Math.pow((n + 0.055) / 1.055, 2.4) : n / 12.92)),
          ...
          function x(t) {
            ...
            return (
              ...
              [(e = e / 95.047 <= 0.008856 ? (e = (95.047 * (r / 500 + a - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + a, 3)), i, (n = n / 108.883 <= 0.008859 ? (n = (108.883 * (a - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(a - s / 200, 3))]
            );
          }
          function y(t) {
            var e,
              ...
              t.controllers.bubble = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  ...
                  (t._xScale = r),
                    ...
                    (t._datasetIndex = d),
                    (t._index = e),
                    (t._model = { backgroundColor: l.backgroundColor, borderColor: l.borderColor, borderWidth: l.borderWidth, hitRadius: l.hitRadius, pointStyle: l.pointStyle, radius: i ? 0 : l.radius, skip: o.skip || isNaN(c) || isNaN(h), x: c, y: h }),
                    t.pivot();
                },
                setHoverStyle: function (t) {
                  var e = t._model,
      ...
      37: [
        function (t, e, i) {
          ...
          var n = t(25),
            ...
            r = n.global;
          n._set("global", {
            elements: { line: { tension: 0.4, backgroundColor: r.defaultColor, borderWidth: 3, borderColor: r.defaultColor, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } },
          }),
            (e.exports = a.extend({
              draw: function () {
                var t,
              ...
              draw: function (t) {
                ...
                e.skip ||
                  ...
                  void 0 !== t &&
                    ...
                    (i.x < t.left ? (h = (u - i.x) / (t.left - i.x)) : 1.01 * t.right < i.x ? (h = (i.x - u) / (i.x - t.right)) : i.y < t.top ? (h = (d - i.y) / (t.top - i.y)) : 1.01 * t.bottom < i.y && (h = (i.y - d) / (i.y - t.bottom)),
            ...
            draw: function () {
              ...
              if (a.display) {
                ...
                (e.fillStyle = i(a.fontColor, r.defaultFontColor)),
                  (e.font = f),
                  t.isHorizontal() ? ((l = b + (y - b) / 2), (u = v + p), (s = y - b)) : ((l = "left" === a.position ? b + p : y - p), (u = v + (x - v) / 2), (s = x - v), (m = Math.PI * ("left" === a.position ? -0.5 : 0.5))),
                  e.save(),
                  e.translate(l, u),
                  e.rotate(m),
                  (e.textAlign = "center"),
    ...
    : ((t.prototype.beforeDatasetsUpdate = function (t) {
      ...
      (t.prototype.drawDataset = function (t) {
        for (var e = this.ctx, i = this.chartInstance, o = t._meta[Object.keys(t._meta)[0]], a = 0, s = 0; s < o.data.length; s++) {
          ...
          if (0 !== n.circumference || this.showZero) {
            ...
            if (("function" == typeof this.render && "object" == typeof (h = this.render({ label: i.config.data.labels[s], value: t.data[s], percentage: l, dataset: t, index: s })) && (h = this.loadImage(h)), !h)) break;
            if ((e.save(), e.beginPath(), (e.font = Chart.helpers.fontString(this.fontSize, this.fontStyle, this.fontFamily)), "outside" === this.position || ("border" === this.position && "pie" === i.config.type))) {
              ...
              if (("border" === this.position ? (f = (n.outerRadius - c) / 2 + c) : "outside" === this.position && (f = n.outerRadius - c + c + p), (d = { x: n.x + Math.cos(d) * f, y: n.y + Math.sin(d) * f }), "outside" === this.position)) {
            ...
            if (
              ("function" == typeof (p = this.fontColor)
                ? (p = p({ label: i.config.data.labels[s], value: t.data[s], percentage: l, text: h, backgroundColor: t.backgroundColor[s], dataset: t, index: s }))
      ...
      (t.prototype.drawArcText = function (t, e, i, o) {
        ...
        if (((n += ((i += Math.PI / 2) - ((s = this.measureText(t)).width / e + n)) / 2), o || !(i - n > r)))
          if ("string" == typeof t) for (a.rotate(n), o = 0; o < t.length; o++) (n = t.charAt(o)), (s = a.measureText(n)), a.save(), a.translate(0, -1 * e), a.fillText(n, 0, 0), a.restore(), a.rotate(s.width / e);
